import {
      ...
      return (
        ...
        .overlay {
          ...
          .overlay.hidden {
            ...
            pointer-events: none; /* Désactive les clics une fois caché */
          }
  ...
  {/* Overlay pour l'effet de chargement */}
  {isOverlayVisible && (
          <div className={`overlay ${!isOverlayVisible ? "hidden" : ""}`} style={{ display: "flex" }}>
            <div>
                AAAAAA
            </div>
