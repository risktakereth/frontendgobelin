...
if (maxEligibleGuard) {
    ...
    return <Box margin={"0px 0px 0px 0px"} padding={"0px"} borderRadius={"10px"}>
...
<VStack flexDirection="row" alignItems="center" margin="20px 0px 5px 0px">
<Tooltip label={"You cannot mint for now"} aria-label="Mint button" justifyContent="end">
  ...
  >
    ...
    const listItems = buttonGuardList.map((buttonGuard, index) => (
      <Box key={index} margin={"20px 0px 5px 0px"} bg={"transparent"} padding={"0px"} borderRadius={"10px"}>
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet"></link>
  {/* Mint Text avec bouton déroulant */}
  ...
  {/* Boutons et contrôles existants */}
  <VStack flexDirection="row" alignItems="center" marginTop="0px">
